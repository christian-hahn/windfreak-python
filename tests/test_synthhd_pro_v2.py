...
This module contains unit-tests for the SynthHD object specific to SynthHD PRO v2.
"""
...
class SynthHDPROv2TestCase(unittest.TestCase, SynthHDv2BaseTestCase):
    ...
    def test_model(self):
        ...
        self.assertEqual(model, 'SynthHD PRO v2')

    def test_frequency_range(self):
        expected = {'start': 10.e6, 'stop': 24000.e6, 'step': 0.1}
...
if __name__ == '__main__':
    if len(sys.argv) > 1:
        SynthHDPROv2TestCase.DEVPATH = sys.argv.pop()
    unittest.main()
